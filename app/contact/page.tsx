                     ...
                     <div className="space-y-8">
                         <div className="flex items-start">
                             <div className="flex-shrink-0">
                                 <div className="flex items-center justify-center w-12 h-12 rounded-lg bg-blue-100 text-blue-600 dark:bg-blue-900/30 dark:text-blue-400">
                 ...
                 <div className="bg-gray-50 dark:bg-slate-800 p-8 rounded-sm border border-gray-100 dark:border-gray-700">
                     <form className="space-y-6">
                         <div>
                             ...
                             <input type="text" id="name" className="mt-1 block w-full rounded-full border-gray-300 dark:border-gray-600 shadow-sm focus:border-blue-500 focus:ring-blue-500 bg-white dark:bg-slate-700 py-3 px-4" placeholder="Masukkan nama Anda" />
                         </div>
                         <div>
                             <label htmlFor="email" className="block text-sm font-medium text-gray-700 dark:text-gray-300">Email address</label>
                             <input type="email" id="email" className="mt-1 block w-full rounded-full border-gray-300 dark:border-gray-600 shadow-sm focus:border-blue-500 focus:ring-blue-500 bg-white dark:bg-slate-700 py-3 px-4" placeholder="nama@perusahaan.com" />
                         </div>
                         <div>
                             <label htmlFor="subject" className="block text-sm font-medium text-gray-700 dark:text-gray-300">Subjek</label>
                             <select id="subject" className="mt-1 block w-full rounded-full border-gray-300 dark:border-gray-600 shadow-sm focus:border-blue-500 focus:ring-blue-500 bg-white dark:bg-slate-700 py-3 px-4">
                         ...
                         <div>
                             ...
                             <textarea id="message" rows={4} className="mt-1 block w-full rounded-sm border-gray-300 dark:border-gray-600 shadow-sm focus:border-blue-500 focus:ring-blue-500 bg-white dark:bg-slate-700 py-3 px-4" placeholder="Ceritakan kebutuhan Anda..."></textarea>
                         </div>
