...
export default function Navbar() {
  ...
  return (
    <nav className="bg-white dark:bg-slate-900/90 sticky top-0 z-50 border-b border-gray-100 dark:border-gray-800 backdrop-blur-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-20 items-center">
          <div className="flex-shrink-0 flex items-center gap-2">
            <Link href="/" className="flex items-center gap-2 group">
              ...
              <div className="flex flex-col justify-center">
                  <span className="font-extrabold text-xl tracking-tighter text-sky-900 dark:text-white group-hover:text-sky-600 transition-colors leading-none">Edula</span>
                  <span className="hidden lg:block text-[10px] uppercase tracking-widest text-sky-900 font-bold leading-none mt-0.5"><span className="text-red-500">DIT</span> Education</span>
              </div>
            </Link>
          </div>
          ...
          <div className="hidden md:flex items-center gap-4">
               <Link href="/contact" className="px-5 py-2 text-sm font-bold text-white bg-sky-600 hover:bg-sky-700 rounded-full transition-shadow">
                    Demo Gratis
               </Link>
          </div>
